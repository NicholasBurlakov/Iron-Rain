...
- [x] Enemy health bars, death, and corpse fading
...
- [x] Multiple waves
- [x] Custom wave compositions
- [x] Enemy difficulty increases through count and composition, not stat scaling
- [x] Enemy movement speed reduced across all waves
...
- [ ] Better terrain visuals integrated into map art

## Milestone 7 — Combat Feedback and Readability

- [x] Floating damage numbers
- [x] Cover-reduced damage feedback
