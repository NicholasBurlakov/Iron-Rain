...
* [x] Map background
* [x] Enemy waypoint pathing
* [x] Enemy health bars, death, and corpses
* [x] Towers, projectiles, and damage
* [x] Deployable Rifle, Heavy, and Turret
* [x] Unit selection and movement
* [x] Multiple enemies and wave spawning
* [x] Supply income and deployment costs
* [x] Win, loss, and restart states
* [x] Multiple waves
* [x] Basic enemy types: Grunt, Scout, Heavy
...
* [x] Dropship deployment for units
* [x] Orbital cargo-pod deployment for structures
* [x] Reusable dropship fleet
* [x] Orbital pod fabrication cooldown
...
* [x] Command Post
  * [x] Adds Command Capacity while alive
  * [x] Can be destroyed by enemies
  * [x] Existing forces remain when capacity falls below current usage
  * [x] Capacity-costing deployments are blocked while over capacity
  * [x] Zero-capacity Mines and Command Posts remain deployable
...
## Milestone 6 — Terrain, Cover, and Battlefield Effects

* [x] Terrain zones
* [x] Visible terrain testing overlays
* [x] Rough terrain movement penalty
* [x] Cover zones
* [x] Random Cover damage reduction per hit
...
* [ ] Fortified positions
* [ ] Bunker-provided friendly cover
* [ ] Better terrain visuals integrated into the map art
...
## Milestone 8 — Territory and Frontline

* [ ] Player and enemy territory
* [ ] Deployment restricted to friendly territory
* [ ] Territory capture system
* [ ] Frontline movement
* [ ] Objectives that increase Supply income
* [ ] Objectives that increase Command Capacity
* [ ] Forward deployment positions
* [ ] Strategic capture points

## Milestone 9 — Support Abilities
...
## Milestone 10 — Campaign

* [ ] Main menu
* [ ] Level selection
* [ ] Mission rewards
* [ ] War Credits
* [ ] Unit and structure unlocks
* [ ] Permanent upgrades
* [ ] Save progress
* [ ] Mission briefing and debriefing screens

## Milestone 11 — Art, Animation, Audio, and Polish
